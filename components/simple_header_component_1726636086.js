                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home">
                            <a
                                href="#"
                                class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded-lg lg:bg-transparent lg:text-pink-300 lg:p-0 hover:text-white transition-colors duration-300"
                                aria-current="page"
                            >
                                Bolt Design Studio
                            </a>
                        ...
                        <li id="nav-item-1">
                            <a
                                href="#"
                                class="block py-2 pl-3 pr-4 text-white rounded-lg hover:bg-purple-700 lg:hover:bg-transparent lg:hover:text-pink-300 lg:p-0 transition-colors duration-300"
                            >
